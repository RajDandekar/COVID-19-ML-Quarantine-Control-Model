...
using Plots
using Measures
scatter(Time, Infected, xaxis = "Time(Days)", yaxis = "Italy - Number", label = "Data: Infected", legend = :bottomright, framestyle = :box, left_margin = 5mm)
scatter!(Time, Recovered, xaxis = "Time(Days)", yaxis = "Italy - Number", label = "Data: Recovered", legend = :bottomright, framestyle = :box, left_margin = 5mm)
scatter!(Time, Dead, xaxis = "Time(Days)", yaxis = "Italy - Number", label = "Data: Dead", legend = :bottomright, framestyle = :box, left_margin = 5mm)
#=
...
scatter(Loss_Italy, xaxis = "Number of iterations", yaxis = L"L(W, \beta, gamma)", label = "Italy training", legend = :topleft, framestyle = :box, left_margin = 5mm, color = :green)

# Nature_US_New_Final_Effective_Reproduction_Number_Time
...
#savefig("Nature_Italy_New_Final_Effective_Reproduction_Number_Time.pdf")

#scatter(p3[52]/p3[53], xlabel = "Time(Days)", ylabel = "Base Reproduction Ratio", label = "Italy Data", legend = :bottomright)
...
#savefig("Nature_Italy_New_Final_NN_Quarantine_Beta_Iterations.pdf")
...
Pkg.add("JLD")
using JLD
save("Italy_QSIR_Deadn.jld",  "Q_parameter", Q_parameter , "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss, "T_NN_all_loss", T_NN_all_loss, "t", t, "Parameters", p3, "Loss", Loss, "P1", P1, "P2", P2)
...
scatter(t,Q_pop, xlabel = "Days since 27 Feb 2020", ylabel = "Italy: number of cases", label = "Quarantined: Prediction",color = :green, framestyle = :box, grid =:off, legend = :topleft, left_margin = 5mm, bottom_margin = 5mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)
savefig("RD_Nature_QSIR_14n.pdf")
=#

#savefig("Nature_Italy_New_Final_NN_Quarantine_Loss_Iterations.pdf")
...
scatter(Time, Infected, yaxis = "Italy: Number of cases", label = "Data: Infected", legend = :topleft, framestyle = :box, left_margin = 5mm, color = :red)
plot!(t_n, predictionn[2, :], xticks = ([0:25:50;], ["27 Feb' 20", "23 March' 20", "17 April' 20"]),  yaxis = "Italy: Number of cases", label = "Infected forecast", legend = :topleft, framestyle = :box, left_margin = 5mm, bottom_margin = 5mm, top_margin = 5mm, right_margin = 5mm, grid = :off, color = :red, linewidth  = 3, ylims = (0, 80000), foreground_color_legend = nothing, background_color_legend = nothing, yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)

#savefig("RD_Nature_QSIR_1.pdf")

scatter!(Time, Recovered, yaxis = "Italy: Number of cases", label = "Data: Recovered", legend = :topleft, framestyle = :box, left_margin = 5mm, color = :blue)
plot!(t_n, predictionn[3, :], xticks = ([0:25:50;], ["27 Feb' 20", "23 March' 20", "17 April' 20"]),  yaxis = "Italy: Number of cases", label = "Recovered forecast ", legend = :topleft, framestyle = :box, left_margin = 5mm, bottom_margin =5mm, top_margin = 5mm,right_margin = 8mm,grid = :off, color = :blue, linewidth  = 3, ylims = (0, 100000), foreground_color_legend = nothing,background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)


savefig("Italy_4dn.pdf")
...
scatter(t_n[30:50],Q_parameter[30:50]/u0[1], ylabel = "Q(t)",  ylims = (0.5, 1.2), xticks = ([30:10:50;], ["30", "40", "50"]), xlabel = "Days post 500 infected", label = "Quarantine Strength",color = :black, framestyle = :box, grid =:off, legend = :topleft, left_margin = 5mm, bottom_margin = 5mm, right_margin = 8mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)

#scatter(t_n,Q_parameter/u0[1], ylabel = "Q(t)",  ylims = (0.5, 1.2),xticks = ([0:25:50;], ["27 Feb' 20", "23 March' 20", "17 April' 20"]), label = "Quarantine Strength",color = :black, framestyle = :box, grid =:off, legend = :topleft, left_margin = 5mm, bottom_margin = 5mm, right_margin = 8mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)


savefig("Italy_5dn.pdf")

#savefig("Nature_Italy_New_Final_Quarantine_Strength_Time.pdf")
using LaTeXStrings
scatter(t_n[30:50], abs(p3n[62]) ./ (abs(p3n[63]) .+ Q_parameter[30:50]/u0[1]), ylims = (0.5, 1.5),  xticks = ([30:10:50;], ["30", "40", "50"]), xlabel = "Days post 500 infected",  ylabel = L"R_{t}", label = "Effective reproduction number", right_margin = 8mm, legend = :topright, color = :black, framestyle = :box, grid =:off, foreground_color_legend = nothing, background_color_legend = nothing, yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12, left_margin = 5mm, bottom_margin= 5mm)
f(x) = 1
plot!(f, color = :blue, linewidth = 3, label = L"R_{t} = 1")

savefig("Italy_6dn.pdf")
#=
using JLD
save("Italy_Nature_QSIR.jld",  "Q_parameter", Q_parameter , "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss, "t", t, "Parameters", p3, "Loss", Loss, "P1", P1, "P2", P2)
=#
...
#=scatter(Time', Infected[1, :], xaxis = "Time(Days)", yaxis = "Italy - Number", label = "Data: Infected", legend = :bottomright, framestyle = :box, left_margin = 5mm)
scatter!(Time', Recovered[1, :], xaxis = "Time(Days)", yaxis = "Italy - Number", label = "Data: Recovered", legend = :bottomright, framestyle = :box, left_margin = 5mm)
...
########################## FORECASTING ASSUMING NO QUARANTINE ###################3

function QSIR_original(du, u, p, t)
    β = abs(p[62])
    γ = abs(p[63])
    du[1]=  - β*u[1]*(u[2])/u0[1]
    du[2] = β*u[1]*(u[2])/u0[1] - γ*u[2]
    du[3] = γ*u[2]
    du[4] =  0
end
...
datasize_n = 50;
t_n = range(tspan_n[1],tspan_n[2],length=datasize_n)
prob_n = ODEProblem(QSIR_original, u0, tspan_n, p3n)
predictionn = Array(concrete_solve(prob_n,Rosenbrock23(autodiff = false),u0,p3n,saveat=t_n))
...
scatter(t_n[30:50],Q_parameter[30:50]/u0[1], ylabel = "Q(t)",  ylims = (0.8, 1.2), xticks = ([30:10:50;], ["30", "40", "50"]), xlabel = "Days post 500 infected", label = "Quarantine Strength",color = :black, framestyle = :box, grid =:off, legend = :topleft, left_margin = 5mm, bottom_margin = 5mm, right_margin = 8mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)

#scatter(t_n,Q_parameter/u0[1], ylabel = "Q(t)",  ylims = (0.5, 1.2),xticks = ([0:25:50;], ["27 Feb' 20", "23 March' 20", "17 April' 20"]), label = "Quarantine Strength",color = :black, framestyle = :box, grid =:off, legend = :topleft, left_margin = 5mm, bottom_margin = 5mm, right_margin = 8mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)


savefig("Italy_5n.pdf")

#savefig("Nature_Italy_New_Final_Quarantine_Strength_Time.pdf")
using LaTeXStrings
g(x) = abs(p3n[62]) / (abs(p3n[63]) )
plot(g, xticks = ([30:10:50;], ["30", "40", "50"]), xlabel = "Days post 500 infected",  ylabel = "R(t)", label = "Effective reproduction number", right_margin = 8mm, legend = :topright, color = :black, framestyle = :box, grid =:off, foreground_color_legend = nothing, background_color_legend = nothing, yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12, left_margin = 5mm, bottom_margin= 5mm)

f(x) = 1
plot!(f, color = :blue, linewidth = 3, label = "R = 1")

savefig("Italy_6n.pdf")
