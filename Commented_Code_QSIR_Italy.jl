...
#Rosenbrock is a stiff solver. It works even if while doing iterations, the ODE becomes stiff. However stiff solvers are slow. To gain speed: replace Tsit5() with Tsit5() instead which is a non stiff solver.
