...
using Plots
using Measures
scatter(Time, Infected, xaxis = "Time(Days)", yaxis = "Korea - Number", label = "Data: Infected", legend = :bottomright, framestyle = :box, left_margin = 5mm)
scatter!(Time, Recovered, xaxis = "Time(Days)", yaxis = "Korea - Number", label = "Data: Recovered", legend = :bottomright, framestyle = :box, left_margin = 5mm)
scatter!(Time, Dead, xaxis = "Time(Days)", yaxis = "Korea - Number", label = "Data: Dead", legend = :bottomright, framestyle = :box, left_margin = 5mm)
#=
...
#savefig("Nature_Korea_New_Final_Effective_Reproduction_Number_Time.pdf")

#scatter(p3[52]/p3[53], xlabel = "Time(Days)", ylabel = "Base Reproduction Ratio", label = "Korea Data", legend = :bottomright)
...
#savefig("Nature_Korea_New_Final_NN_Quarantine_Beta_Iterations.pdf")
...
Pkg.add("JLD")
using JLD
save("Korea_QSIR_Dead.jld",  "Q_parameter", Q_parameter , "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss, "T_NN_all_loss", T_NN_all_loss, "t", t, "Parameters", p3, "Loss", Loss, "P1", P1, "P2", P2)
...
scatter(t,Q_pop, xlabel = "Days since 22 Feb 2020", ylabel = "Korea: number of cases", label = "Quarantined: Prediction",color = :green, framestyle = :box, grid =:off, legend = :topleft, left_margin = 5mm, bottom_margin = 5mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)
savefig("RD_Nature_QSIR_14n.pdf")
=#

#savefig("Nature_Korea_New_Final_NN_Quarantine_Loss_Iterations.pdf")
...
scatter(Time, Infected, yaxis = "Korea: Number of cases", label = "Data: Infected", legend = :topleft, framestyle = :box, left_margin = 5mm, color = :red)
plot!(t_n, predictionn[2, :], xticks = ([0:25:50;], ["22 Feb' 20", "18 March' 20", "12 April' 20"]),  yaxis = "Korea: Number of cases", label = "Infected forecast", legend = :topleft, framestyle = :box, left_margin = 5mm, bottom_margin = 5mm, top_margin = 5mm, right_margin = 5mm, grid = :off, color = :red, linewidth  = 3, ylims = (0, 80000), foreground_color_legend = nothing, background_color_legend = nothing, yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)
#savefig("RD_Nature_QSIR_1.pdf")

scatter!(Time, Recovered + Dead, yaxis = "Korea: Number of cases", label = "Data: Recovered", legend = :topleft, framestyle = :box, left_margin = 5mm, color = :blue)
plot!(t_n, predictionn[3, :], xticks = ([0:25:50;], ["22 Feb' 20", "18 March' 20", "12 April' 20"]),  yaxis = "Korea: Number of cases", label = "Recovered forecast ", legend = :topleft, framestyle = :box, left_margin = 5mm, bottom_margin =5mm, top_margin = 5mm,right_margin = 8mm,grid = :off, color = :blue, linewidth  = 3, ylims = (0, 20000), foreground_color_legend = nothing,background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)


savefig("Korea_4d.pdf")
...
T_NN_all_loss = predictionn[4, :]
 ...
 for i = 1:length(S_NN_all_loss)
   Q_parameter[i] = 5*abs(re(p3n[1:61])([S_NN_all_loss[i],I_NN_all_loss[i], R_NN_all_loss[i], T_NN_all_loss[i]])[1])
 end

scatter(t_n[25:50],Q_parameter[25:50]/u0[1],  ylims = (0.75, 1), ylabel = "Q(t)",  xticks = ([25:10:45;], ["25", "35", "45"]), xlabel = "Days post 500 infected"
...
#scatter(t_n[25:50],Q_parameter[25:50]/u0[1], ylims = (1, 1.5), ylabel = "Q(t)",  xticks = ([0:25:50;], ["22 Feb' 20", "18 March' 20", "12 April' 20"]), label = "Quarantine Strength",color = :black, framestyle = :box, grid =:off, legend = :topleft, left_margin = 5mm, bottom_margin = 5mm, right_margin = 8mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)
savefig("Korea_5d.pdf")

#savefig("Nature_Korea_New_Final_Quarantine_Strength_Time.pdf")
using LaTeXStrings
scatter(t_n[25:50], abs(p3n[62]) ./ (abs(p3n[63]) .+ Q_parameter[25:50]/u0[1]), ylims = (0.5, 1.5), xticks = ([25:10:45;], ["25", "35", "45"]), xlabel = "Days post 500 infected"
...
savefig("Korea_6d.pdf")

#=
using JLD
save("Korea_Nature_QSIR.jld",  "Q_parameter", Q_parameter , "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss, "t", t, "Parameters", p3, "Loss", Loss, "P1", P1, "P2", P2)
=#
...
#=scatter(Time', Infected[1, :], xaxis = "Time(Days)", yaxis = "Korea - Number", label = "Data: Infected", legend = :bottomright, framestyle = :box, left_margin = 5mm)
scatter!(Time', Recovered[1, :], xaxis = "Time(Days)", yaxis = "Korea - Number", label = "Data: Recovered", legend = :bottomright, framestyle = :box, left_margin = 5mm)
