...
scatter!(Time[1:39], R[1:39] +  D[1:39], xaxis = "Days since 24 Jan 2020", yaxis = "Wuhan: Number of cases", label = "Data: Recovered", legend = :topleft, framestyle = :box, left_margin = 5mm, color = :blue)
